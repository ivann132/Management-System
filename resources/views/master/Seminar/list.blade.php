                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#modalEdit{{$row->id}}" data-toggle="modal" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
                                            ...
                                            <a href="{{ asset('penyimpanan/Seminar/' . $row->nama_file) }}" target="_blank" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> View File</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
<div class="modal fade" id="modalCreate" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/Seminar/store" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama Mahasiswa</label>
                        <input type="text" class="form-control" name="nama_mahasiswa" placeholder="nama_mahasiswa" required>
                    </div>
                    <div class="form-group">
                        <label>Tanggal</label>
                    ...
                    <div class="form-group">
                        <label>No Seminar</label>
                        <input type="text" class="form-control" name="no_seminar" placeholder="No Seminar" required>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="modalEdit{{$d->id}}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/Seminar/update/{{$d->id}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama Mahasiswa</label>
                    ...
                    <div class="form-group">
                        <label>Semester</label>
                        <input type="text" value="{{$d->semester}}" class="form-control" name="semester" placeholder="semester" required>
                    </div>
                    <div class="form-group">
                        <label>No Seminar</label>
                        <input type="text" value="{{$d->no_seminar}}" class="form-control" name="no_seminar" placeholder="No Seminar" required>
                    </div>
                    <div class="form-group">
                        <label>Nama File</label>
...
<div class="modal fade" id="modalHapus{{$c->id}}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/Seminar/destroy/{{$c->id}}" method="GET">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
