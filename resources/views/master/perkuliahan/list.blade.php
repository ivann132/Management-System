                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                <tbody>
                                    ...
                                    $no = 1;
                                    @endphp
                                    @foreach ($data_perkuliahan as $row)
                                    <tr>
                                        <td>{{$no++}}</td>
                                        ...
                                        <td><a href="#modalEdit{{$row->id}}" data-toggle="modal" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
                                            ...
                                            <a href="{{ asset('penyimpanan/perkuliahan/' . $row->nama_file) }}" target="_blank" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> View File</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
<div class="modal fade" id="modalCreate" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/perkuliahan/store" method="POST" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="modalEdit{{$d->id}}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/perkuliahan/update/{{$d->id}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label>Mata Kuliah</label>
                        <input type="text" value="{{$d->mata_Kuliah}}" class="form-control" name="mata_Kuliah" placeholder="Mata kuliah" required>
                    </div>
                    <div class="form-group">
                        <label>Semester</label>
                    ...
                    <div class="form-group">
                        <label>SKS</label>
                        <input type="text" value="{{$d->sks}}" class="form-control" name="sks" placeholder="SKS" required>
                    </div>
                    <div class="form-group">
                        <label>No SK</label>
...
<div class="modal fade" id="modalHapus{{$c->id}}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/perkuliahan/destroy/{{$c->id}}" method="GET">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
